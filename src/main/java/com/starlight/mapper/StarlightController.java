...
import com.starlight.controller.ExamplePlugin;
...
public class StarlightController {
	...
	public TweetPage index(int page) {
		...
		tweetpage.setPageCount(count/ExamplePlugin.count+1);
        
		properties.setProperty("page", String.valueOf(page));
        pageplugin.setProperties(properties);
		List<Tweet> tweets = tweetmapper.getAllByOrderByIdDesc();
